...
fun make-default-typs():
  ...
  default-typs.set-now(A.s-global("_spyret_false_p").key(), t-arrow([list: t-top], t-boolean))
  ...
  default-typs.set-now(A.s-global("_spyret_sgn").key(), t-arrow([list: t-number], t-number))
  ...
  default-typs.set-now(A.s-global("_spyret_char_upper_case_p").key(), t-arrow([list: t-top], t-boolean))
  default-typs.set-now(A.s-global("_spyret_char_lower_case_p").key(), t-arrow([list: t-top], t-boolean))
  ...
  default-typs.set-now(A.s-global("_spyret_caaar"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_caadr"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_caar"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_cadar"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_caddr"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_cadr"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_car"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_cdaar"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_cdadr"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_cdar"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_cddar"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_cdddr"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_cddr"), t-arrow([list: t-top], t-top))
  default-typs.set-now(A.s-global("_spyret_cdr"), t-arrow([list: t-top], t-top))
  ...
  default-typs.set-now(A.s-global("num-is-complexrational").key(), t-arrow([list: t-number], t-boolean))
  default-typs.set-now(A.s-global("num-is-complexroughnum").key(), t-arrow([list: t-number], t-boolean))
...
module-const-lists = t-module("pyret-builtin://lists",
  t-record([list:
    ...
    t-member("index", t-forall([list: t-var(s-atom("A", 133))], t-arrow([list: mk-list(t-var(s-atom("A", 133))), t-number], t-var(s-atom("A", 133))))),
