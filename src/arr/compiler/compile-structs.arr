...
runtime-provides = provides("builtin://global",
  [string-dict:
    ...
    "_spyret_inexact_to_exact", t-arrow([list: t-number], t-number),
    "_spyret_exact_to_inexact", t-arrow([list: t-number], t-number),
    "_spyret_lcm", t-top,
    "_spyret_le", t-top,
    "_spyret_lt", t-top,
    "_spyret_max", t-top,
    ...
    "_spyret_add1", t-arrow([list: t-number], t-number),
    "_spyret_sub1", t-arrow([list: t-number], t-number),
    "_spyret_plus", t-top,
    ...
    "_spyret_number_to_string", t-top,
