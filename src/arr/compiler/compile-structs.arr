...
runtime-builtins = [string-dict:
  ...
  "_spyret_le", T.t-top,
  "_spyret_ge", T.t-top,
  "_spyret_string_eq", T.t-top,
  "_spyret_string_lt", T.t-top,
  "_spyret_string_gt", T.t-top,
  "_spyret_string_le", T.t-top,
  "_spyret_string_ge", T.t-top,
  "_spyret_string_ci_eq", T.t-top,
  "_spyret_string_ci_lt", T.t-top,
  "_spyret_string_ci_gt", T.t-top,
  "_spyret_string_ci_le", T.t-top,
  "_spyret_string_ci_ge", T.t-top,
  "_spyret_substring", T.t-top,
  "_spyret_char_p", T.t-top,
